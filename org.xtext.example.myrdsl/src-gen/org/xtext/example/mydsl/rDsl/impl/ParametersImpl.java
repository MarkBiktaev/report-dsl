 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.rDsl.impl.ParametersImpl#getParameter <em>Parameter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParametersImpl extends MinimalEObjectImpl.Container implements Parameters
{
  ...
  {
    return RDslPackage.eINSTANCE.getParameters();
  }
  ...
  public EList<Parameter> getParameter()
  {
    if (parameter == null)
    {
      parameter = new EObjectContainmentEList<Parameter>(Parameter.class, this, RDslPackage.PARAMETERS__PARAMETER);
    }
    return parameter;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RDslPackage.PARAMETERS__PARAMETER:
