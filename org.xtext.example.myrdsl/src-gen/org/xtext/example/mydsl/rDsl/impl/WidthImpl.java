 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.rDsl.impl.WidthImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WidthImpl extends MinimalEObjectImpl.Container implements Width
{
  ...
  {
    return RDslPackage.eINSTANCE.getWidth();
  }
  ...
  public NotificationChain basicSetValue(IndentValue newValue, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RDslPackage.WIDTH__VALUE, oldValue, newValue);
  ...
  public void setValue(IndentValue newValue)
  {
    if (newValue != value)
    {
      ...
      if (value != null)
        msgs = ((InternalEObject)value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RDslPackage.WIDTH__VALUE, null, msgs);
      if (newValue != null)
        msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RDslPackage.WIDTH__VALUE, null, msgs);
      msgs = basicSetValue(newValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RDslPackage.WIDTH__VALUE, newValue, newValue));
  }
