 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.rDsl.impl.BodyImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BodyImpl extends MinimalEObjectImpl.Container implements Body
{
  ...
  {
    return RDslPackage.eINSTANCE.getBody();
  }
  ...
  public EList<ReportElements> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<ReportElements>(ReportElements.class, this, RDslPackage.BODY__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RDslPackage.BODY__ELEMENTS:
